...
public class DoublyLinkedListTest {
    ...
    /**
     * Test removeFromFront() for a list of size 1.
     */
    @Test
    public void removeFromFrontSize1() {
        list.addToBack("a");
        assertEquals(list.removeFromFront(), "a", "Removing does not return "
                + "item");
        assertDLLEquals(List.of());
    }
    ...
    /**
     * Test removeFromBack() for a list of size 1.
     */
    @Test
    public void removeFromBackSize1() {
        list.addToBack("a");
        assertEquals(list.removeFromBack(), "a", "Removing does not return "
                + "item");
        assertDLLEquals(List.of());
    }
